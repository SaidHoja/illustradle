...
def hint():
    letters = request.form["letters_revealed"] # add front end validation for only 1 letter left. 
...
def winner():
    num_hints = int(request.form["num_hints"]) # add front end validation for only 1 letter left. 
